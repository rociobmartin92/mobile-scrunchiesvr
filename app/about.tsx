      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.content}>
            ...
            <Text style={[styles.text, styles.marginTop]}>
              Esta tienda nació como un espacio para compartir mis creaciones
              con el mundo y también mostrar mis habilidades en el desarrollo de
              software.
              ...
              Zustand
              {"\n\n"}
              Cada pieza que hago está hecha con dedicación, cariño y un toque
              de la naturaleza que me rodea. ✨{"\n\n"}¡Espero que encuentres
              algo que te encante tanto como a mí me gusta hacerlo! 💖
            </Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity
              onPress={() =>
                Linking.openURL("mailto:martinrocio.1992@gmail.com")
              }
            >
